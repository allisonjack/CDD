...
/usr/local/fsl-5.0.8/bin/randomise -i $INPUT -m $MASK -o ${ROOTDIR}/$OUTPUT -d $ROOTDIR/${DESIGN}.mat -t $ROOTDIR/${DESIGN}.con -f $ROOTDIR/${DESIGN}.fts -D --T2 --uncorrp >> ${OUTPUT}_stdout.txt
